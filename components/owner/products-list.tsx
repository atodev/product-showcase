...
const BUILTIN = [
  { id: "interview-edge", name: "Interview Edge", tagline: "AI-powered candidate intelligence", color: "blue" as const, status: "active" as const },
  { id: "ona-dashboard",  name: "ONA Dashboard",  tagline: "Organisational network analytics",  color: "violet" as const, status: "active" as const },
]
