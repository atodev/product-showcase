...
title: "t-rade"
date: "2026-04-03"
excerpt: "# Building an Autonomous Crypto Trading Bot on a Raspberry Pi"
tags: ["AI", "Crypto"]
notebooklm: ""
audio: ""
audioTitle: ""
...
The core idea is simple: find crypto assets in the early stages of a momentum move, enter with a calculated position, trail the stop loss to lock in gains, and exit cleanly. Do this repeatedly, let the AI optimise the parameters, and compound the results. I created the UI in a vintage occilloscope style.
![alt text](/images/t-rared0.jpg)
